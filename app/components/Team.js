...
const TeamCard = ({ member }) => {
  return (
    <div className="relative flex-shrink-0 w-[200px] md:w-[280px] group select-none">
      <div className="relative overflow-hidden bg-white/[0.03] backdrop-blur-xl border border-white/10 rounded-[1.8rem] md:rounded-[2rem] p-5 md:p-8 transition-all duration-500 hover:border-cyan-500/50 hover:bg-white/[0.06] hover:-translate-y-2 shadow-2xl">
          ...
          <div className="relative w-20 h-20 md:w-32 md:h-32 mb-4">
            ...
            <div className="relative w-full h-full rounded-full bg-gradient-to-tr from-cyan-400 via-blue-500 to-purple-600 p-[2px] transform transition-transform duration-700 group-hover:rotate-6">
              <div className="w-full h-full rounded-full bg-[#020617] flex items-center justify-center overflow-hidden border-2 border-[#020617]">
                {member.image ? (
                  ...
                  <span className="text-lg md:text-2xl font-black bg-gradient-to-br from-white to-white/40 bg-clip-text text-transparent group-hover:scale-110 transition-transform duration-500">
            ...
            <div className="absolute -inset-1.5 md:-inset-2 flex justify-between items-end pointer-events-none">
              <a 
                ...
                className="pointer-events-auto w-7 h-7 md:w-10 md:h-10 rounded-full bg-gradient-to-tr from-yellow-400 via-red-500 to-purple-600 text-white flex items-center justify-center shadow-lg opacity-0 group-hover:opacity-100 -translate-x-2 md:-translate-x-3 translate-y-2 md:translate-y-3 group-hover:translate-x-0 group-hover:translate-y-0 transition-all duration-300 z-20 hover:scale-110 active:scale-95"
              ...
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="pointer-events-auto w-7 h-7 md:w-10 md:h-10 rounded-full bg-[#0077b5] text-white flex items-center justify-center shadow-lg opacity-0 group-hover:opacity-100 translate-x-2 md:translate-x-3 translate-y-2 md:translate-y-3 group-hover:translate-x-0 group-hover:translate-y-0 transition-all duration-300 z-20 hover:scale-110 active:scale-95"
                onClick={(e) => e.stopPropagation()}
              >
...
const Team = forwardRef((props, ref) => {
  ...
  return (
    <section 
      ref={ref} 
      className="py-16 md:py-32 relative overflow-hidden bg-[#020617] text-white"
      id="team"
    >
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 mb-12 md:mb-24">
        <div className="flex flex-col items-center text-center">
          ...
          >
            <span className="text-cyan-400 font-bold tracking-[0.2em] uppercase text-[9px] md:text-xs">
              The Collective
            </span>
          </motion.div>
          ...
          <motion.h2
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="text-[clamp(2.5rem,8vw,4.5rem)] md:text-7xl font-black tracking-tighter leading-none"
          >
      ...
      >
        {/* Dynamic Edge Masks */}
        <div className="absolute inset-y-0 left-0 w-16 md:w-64 bg-gradient-to-r from-[#020617] via-[#020617]/80 to-transparent z-20 pointer-events-none" />
        <div className="absolute inset-y-0 right-0 w-16 md:w-64 bg-gradient-to-l from-[#020617] via-[#020617]/80 to-transparent z-20 pointer-events-none" />
      ...
      <div className="mt-12 md:mt-16 text-center opacity-30 select-none px-6">
        <p className="text-[10px] md:text-xs uppercase tracking-[0.3em] md:tracking-[0.4em] font-medium italic">Continuous Innovation • AVALANCHE CLUB</p>
      </div>
    </section>
  );
});
