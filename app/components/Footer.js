      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8 mb-16 md:mb-20">
          ...
          <div className="space-y-6 md:space-y-8">
            ...
            <p className="text-slate-400 text-xs md:text-sm leading-relaxed max-w-xs font-bold uppercase tracking-wide opacity-80">
          ...
          <div className="space-y-6">
            <h4 className="text-slate-500 font-black tracking-[0.3em] uppercase text-[10px]">Social Pulse</h4>
            <div className="flex gap-4">
              {SOCIAL_LINKS.map((social, idx) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.9 }}
                  className={`w-14 h-14 rounded-2xl bg-slate-800/50 border border-slate-700/50 flex items-center justify-center text-slate-400 transition-all duration-300 transform-gpu will-change-transform ${social.hoverColor}`}
                >
                  {social.icon}
                </motion.a>
              ))}
        ...
        {/* ===== Bottom Bar ===== */}
        <div className="pt-8 md:pt-10 border-t border-slate-800/50 flex flex-col md:flex-row justify-between items-center gap-6 text-slate-500 text-[10px] font-black tracking-[0.2em] uppercase">
