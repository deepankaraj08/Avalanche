...
// GalleryModal displays the selected media item in a full-screen modal with a draggable dock
const GalleryModal = ({ selectedItem, isOpen, onClose, setSelectedItem, mediaItems }) => {
  ...
  return (
    <>
            ...
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="relative w-full aspect-[16/9] max-w-[95%] sm:max-w-[85%] md:max-w-3xl
                           h-auto max-h-[70vh] rounded-xl overflow-hidden shadow-2xl"
      ...
      >
        <motion.div className="relative rounded-2xl bg-white/10 backdrop-blur-xl border border-white/20 shadow-xl cursor-grab active:cursor-grabbing">
              ...
              >
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-3">
                    <h3 className="text-white text-xs sm:text-sm font-bold tracking-wide line-clamp-1">{item.title}</h3>
                    <p className="text-white/60 text-[10px] sm:text-xs mt-0.5 line-clamp-2">{item.desc}</p>
                  </div>
                </motion.div>
              </motion.div>
            ))}
