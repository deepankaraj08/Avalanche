...
/**
 * A cosmic parallax star-field background component.
 * Stars are generated by random box-shadow values on mount,
 * and animated upward via the `animStar` CSS keyframe (defined in globals.css).
 *
 * Props:
 *  - loop      {boolean} – whether the star animation loops (default: true)
 *  - className {string}  – extra classes placed on the container
 *  - showText  {boolean} – render the built-in title/subtitle (default: false)
 *  - head      {string}  – heading text (only when showText=true)
 *  - text      {string}  – comma-separated subtitle parts (only when showText=true)
 */
const CosmicParallaxBg = ({
  ...
  /** Generate `count` random white pixel box-shadows over a 2000×2000 canvas */
